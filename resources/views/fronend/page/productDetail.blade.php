...
<div class="container mt-5 pt-3">
      ...
      <div class="comments-list text-center text-md-left">
        ...
        <div class="row mb-5">
          ...
          <div class="col-sm-10 col-12">
            ...
            <p class="dark-grey-text article">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis
    ...
    <section id="products" class="pb-5">
      ...
      <p class="text-center w-responsive mx-auto mb-5 dark-grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, error amet numquam iure provident voluptate esse quasi,
